export default {
  ...
  template: `
        <section class="mail-side-bar">
                <div @click="openInbox" class="mail-side-bar-btn" tabindex="0">
                ...
                <div @click="openStared" class="mail-side-bar-btn" tabindex="0">
                  <div class="side-bar-el">
                ...
                <div @click="openSent" class="mail-side-bar-btn" tabindex="0">
                  <div class="side-bar-el">
                ...
                <div @click="openDrafts" class="mail-side-bar-btn" tabindex="0">
                  <div class="side-bar-el">
                ...
                <div @click="openTrash" class="mail-side-bar-btn" tabindex="0">
                  <div class="side-bar-el">
